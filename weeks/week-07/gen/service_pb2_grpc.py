...
class NotificationsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Ping = channel.unary_unary(
                '/notifications.v1.NotificationsService/Ping',
        ...
        self.Subscribe = channel.unary_stream(
                ...
                response_deserializer=service__pb2.NotificationEvent.FromString,
                _registered_method=True)
...
def add_NotificationsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=service__pb2.NotificationEvent.SerializeToString,
            ),
    }
...
class NotificationsService(object):
    ...
    def Subscribe(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            service__pb2.NotificationEvent.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
